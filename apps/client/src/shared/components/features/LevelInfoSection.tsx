...
import { CHIPPY_LEVELS, LEVEL_INFO, LAYOUT, UI_TEXT } from '@shared/constants';
import type { LevelInfoSectionProps } from '@shared/types';
import LevelInfoItem from '@shared/components/features/LevelInfoItem';

const LevelInfoSection = memo(
  ({ className = '' }: LevelInfoSectionProps) => {
